...
<html>
  ...
  <div style="overflow:auto;background-color: #FEFEFE;text-align:center;">
    <div class="menu">
      ...
      <div class="menuitem"><a href="Adj.php" class="text-dark">Matriz adjunta</a></div>
    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-dark" style="padding: 0.1%;">
      <table>
        <tr>
          <td><a role="button" class="btn btn-light" href="Adj.php">Reiniciar</a></td>
    ...
    <div class="main">
      <div style="text-align:center;">
         <p style="font-size:20px;"><br>Cree una matriz nxm</p>
      </div>
    </div>
  </div>
