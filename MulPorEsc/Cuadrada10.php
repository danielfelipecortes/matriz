...
<div class="particion">
<div class="element1"><input type="Submit" value="Calcular" name="Calcular" id="Calcular">
</div>
<div class="element2"><div class="panel-heading"><strong>Matriz</strong></div>
            <?php 
            $i=1;
            for($y;$y<=$b;$y++){
                        $x=1;
...
<div class="element3"><div class="item1"><div class="panel-heading"><strong>Escalar</strong></div>
            <input type="number" style="width : 40px" placeholder="0" name="Esc" id="Esc" value="<?=$Esc?>"/></div>
</div>
<div class="element4"><div class="panel-heading"><strong>Resultado</strong></div>
            <?php 
            $i=1;
            $x=1;
            $y=1;
