...
$dm=(($Nums[1]*$Nums[6]*$Nums[11])+($Nums[2]*$Nums[7]*$Nums[9])+($Nums[3]*$Nums[5]*$Nums[10]))
   -(($Nums[3]*$Nums[6]*$Nums[9])+($Nums[2]*$Nums[5]*$Nums[11])+($Nums[1]*$Nums[7]*$Nums[10]));
$dx=(($Nums[4]*$Nums[6]*$Nums[11])+($Nums[2]*$Nums[7]*$Nums[12])+($Nums[3]*$Nums[8]*$Nums[10]))
   -(($Nums[3]*$Nums[6]*$Nums[12])+($Nums[2]*$Nums[8]*$Nums[11])+($Nums[4]*$Nums[7]*$Nums[10]));
$dy=(($Nums[1]*$Nums[8]*$Nums[11])+($Nums[4]*$Nums[7]*$Nums[9])+($Nums[3]*$Nums[5]*$Nums[12]))
   -(($Nums[3]*$Nums[8]*$Nums[9])+($Nums[4]*$Nums[5]*$Nums[11])+($Nums[1]*$Nums[7]*$Nums[12]));
$dz=(($Nums[1]*$Nums[6]*$Nums[12])+($Nums[2]*$Nums[8]*$Nums[9])+($Nums[4]*$Nums[5]*$Nums[10]))
