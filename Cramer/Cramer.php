...
<html>
  ...
  <div style="overflow:auto;background-color: #FEFEFE;text-align:center;">
    <div class="menu" style="font-family:Verdana;">
      ...
      <div class="menuitem"><a href="Cramer.php" class="text-dark">Sistemas de ecuaciones</a></div>
    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-dark" style="padding: 0.1%;">
      <table style="font-family:Verdana;">
        <tr>
          <td><a role="button" class="btn btn-light" href="Cramer.php">Reiniciar</a></td>
    ...
    <div class="main" style="font-family:Verdana;">
      <div style="text-align:center;">
         <p style="font-size:20px;"><br>Cree un sistema de n incognitas por n ecuaciones</p>
      </div>
    </div>
  </div>
